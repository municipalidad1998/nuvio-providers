...
class DoramasFlixScraper extends StreamScraper {
  @override
  String get name => 'PlayTorrioHTTP';

  static const _baseUrl = 'https://doramasflix.co';
  ...
  Stream<StreamSource> scrapeStream({
    ...
    try {
      ...
      if (kDebugMode) debugPrint('[DoramasFlixScraper] error: $e');
    }
  }
