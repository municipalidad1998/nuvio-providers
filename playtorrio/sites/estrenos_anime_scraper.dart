...
class EstrenosAnimeScraper extends StreamScraper {
  @override
  String get name => 'PlayTorrioHTTP';

  static const _baseUrl = 'https://estrenosanime.net';
  ...
  Stream<StreamSource> scrapeStream({
    ...
    try {
      ...
      if (kDebugMode) debugPrint('[EstrenosAnimeScraper] error: $e');
    }
  }
