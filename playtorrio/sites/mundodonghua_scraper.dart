...
class MundoDonghuaScraper extends StreamScraper {
  @override
  String get name => 'PlayTorrioHTTP';

  static const _baseUrl = 'https://www.mundodonghua.com';
  ...
  Stream<StreamSource> scrapeStream({
    ...
    try {
      ...
      if (kDebugMode) debugPrint('[MundoDonghuaScraper] error: $e');
    }
  }
