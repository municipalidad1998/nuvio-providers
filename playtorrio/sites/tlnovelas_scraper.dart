...
class TLNovelasScraper extends StreamScraper {
  @override
  String get name => 'PlayTorrioHTTP';

  static const _baseUrl = 'https://ww2.tlnovelas.net';
  ...
  Stream<StreamSource> scrapeStream({
    ...
    try {
      ...
      if (kDebugMode) debugPrint('[TLNovelasScraper] error: $e');
    }
  }
